...
- [16/07 ~21:00] Repo público creado: github.com/frosimanuel/senadores · GitHub Pages activo → https://frosimanuel.github.io/senadores/ (dominio custom del user: 0xdwb.is-a.dev/senadores/). Root index.html es copia de web/index.html — al rebuildear, re-copiar y pushear.
